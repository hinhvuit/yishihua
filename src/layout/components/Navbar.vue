    ...
    <div class="right-menu">
      <template v-if="appStore.device !== 'mobile'">
        ...
        <div class="park-select">
          <el-select  style="width: 300px;" v-model="park" placeholder="请选择园区" filterable @change="parkChange">
      ...
      <div style="height: 20px;margin-top: 14px;margin-right: 20px;color: aliceblue;">
...
<script setup>
  ...
  let park = ref(parseInt(getPark()) ? parseInt(getPark()) : '');
