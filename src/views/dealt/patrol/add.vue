...
<template>
  <div class="dealt-container">
    ...
    <div class="main">
      <el-page-header @back="handleBack" style="margin: 10px 0">
        <template #content>
          <span class="text-large font-600 mr-3"> 审核详情 </span>
        </template>
      </el-page-header>
    </div>
    <el-form class="box" :model="formData" ref="formRef" :inline="false" label-width="90px">
      <!-- 基础信息 -->
      <div class="form-item">
                  ...
                  <template #default="scope">
                    <div>
                      <el-form-item
                        ...
                        style="margin-bottom: 20px"
                      >
                        <el-input v-model="item.tableData[scope.$index].patrolResult.context"   type="textarea" placeholder="请输入" />
                      </el-form-item>
