<template>
  <div class="app-container">
        <div>
              ...
              <div v-if="name == signNodes&&(details.status=='2'||details.status=='3'||details.status=='7')"><el-button type="primary" @click="aginBtn()">{{$t('public.againSubmit')}}</el-button></div>
            </div>
    <el-dialog
...
import { getApplicationEnterGuestPage,consolidation,consolidationSubmit,getByEmployeeId, getMainById,isShow,examine,selectOne} from "@/api/india/visitors/business.js";
